 ...
 * https post
 */
public class HttpsPost extends HttpPost{
    private HttpsHelper httpsHelper;


    public HttpsPost(HttpRequestListener listener){
        super(listener);
        httpsHelper=new HttpsHelper();
    }

    public HttpsPost(HttpRequestListener listener,KeyManager[] keyManagers, TrustManager[] trustManagers) {
        super(listener);
