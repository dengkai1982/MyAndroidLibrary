...
/**
 * 带涟漪效果的RelativeLayout
 * 用法,定义 xmlns:app="http://schemas.android.com/apk/res-auto"
   <apk.lib.widget.layout.RippleRelativeLayout
	  android:id="@+id/more"
	  android:layout_width="?android:actionBarSize"
	  android:layout_height="?android:actionBarSize"
	  android:layout_toLeftOf="@+id/more2"
	  android:layout_margin="5dp"
  	  app:rl_centered="true">
	  <ImageView
	    android:layout_width="?android:actionBarSize"
	    android:layout_height="?android:actionBarSize"
	...
	</android.compoment.widget.layout.RippleRelativeLayout>
	如果要在涟漪效果之后添加事件
	rippleLayout.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
        ...
        public void onComplete(RippleView rippleView) {
         ...
         参数说明
    app:rl_alpha [integer def:90 0-255] --> 涟漪透明度
	app:rl_framerate [integer def:10] --> 涟漪动画的帧速率
	app:rl_rippleDuration [integer def:400] --> 涟漪动画的持续事件
	app:rl_ripplePadding [dimension def:0] --> 添加涟漪padding
	app:rl_color [color def:@android:color/white] --> 涟漪颜色
	app:rl_centered [boolean def:false] --> 是否从中心展开
	app:rl_type [enum (simpleRipple, doubleRipple,rectangle) def:rectangle] --> 效果类型
	app:rl_zoom [boolean def:false] --> 启用缩放动画
	app:rl_zoomDuration [integer def:150] --> 缩放动画持续事件
	app:rl_zoomScale [float def:1.03] --> 缩放动画大小
 *
 */
public class RippleRelativeLayout extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleLayout_rl_color,0xff727272);
        rippleType = typedArray.getInt(R.styleable.RippleLayout_rl_type,2);
    ...
    public void draw(Canvas canvas) {
        super.draw(canvas);
        if (animationRunning&&enableEffect) {
            canvas.save();
